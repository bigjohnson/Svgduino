...
namespace TinyWebPutHandler {
  ...
  typedef void (*HandlerFn)(MyTinyWebServer& web_server,
			    PutAction action,
...
class MyTinyWebServer : public Print {
public:
  ...
  typedef boolean (*WebHandlerFn)(MyTinyWebServer& web_server);
  ...
  MyTinyWebServer(PathHandler handlers[], const char** headers);
