...
boolean file_handler(MyTinyWebServer& web_server);
boolean blink_led_handler(MyTinyWebServer& web_server);
boolean led_status_handler(MyTinyWebServer& web_server);
...
MyTinyWebServer::PathHandler handlers[] = {
  ...
  // strings.
  //
  // `put_handler' is defined in MyTinyWebServer
  {"/", MyTinyWebServer::GET, &index_handler },
  {"/upload/" "*", MyTinyWebServer::PUT, &TinyWebPutHandler::put_handler },
  {"/blinkled", MyTinyWebServer::POST, &blink_led_handler },
  {"/ledstatus" "*", MyTinyWebServer::GET, &led_status_handler },
  {"/" "*", MyTinyWebServer::GET, &file_handler },
  {NULL},
};
...
MyTinyWebServer web = MyTinyWebServer(handlers, headers);
...
boolean file_handler(MyTinyWebServer& web_server) {
  char* filename = MyTinyWebServer::get_file_from_path(web_server.get_path());
